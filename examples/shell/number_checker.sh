...
set -euo pipefail
BASE_URL="https://api.numberchecker.ai"; API_KEY="${NUMBERCHECKER_API_KEY:-}"; if [[ -z "$API_KEY" ]]; then echo "NUMBERCHECKER_API_KEY is required" >&2; exit 2; fi; TASK_TYPE="temu"; INPUT_FILE="${1:-examples/numbers.txt}"
